...
\label{fig:SD-login}
\centering
\includegraphics[width=\textwidth, height=\textheight]{register-verify-AD.png}
\end{figure}
...
\label{fig:SD-login}
\centering
\includegraphics[width=\textwidth, height=\textheight]{register-verify-SD.png}
\end{figure}
...
\label{fig:SD-login}
\centering
\includegraphics[width=\textwidth, height=\textheight]{login-AD.png}
\end{figure}
...
\label{fig:SD-login}
\centering
\includegraphics[width=\textwidth, height=\textheight]{give-permission-SD.png}
\end{figure}
...
\label{fig:SD-login}
\centering
\includegraphics[width=\textwidth, height=\textheight]{view-history-SD.png}
\end{figure}
